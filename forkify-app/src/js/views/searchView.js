 ...
 *  acc: 9 / acc + cur.length = 5/ newTitle = ['Pasta with']
 *  acc: 15 / acc + cur.length = 5/ newTitle = ['Pasta with tomato']
 *  acc: 18 / acc + cur.length = 5/ newTitle = ['Pasta with tomato']
 *  acc: 24 / acc + cur.length = 5/ newTitle = ['Pasta with tomato']
 */
